...
ROOT_URLCONF = 'legaltech_backend.urls'
...
WSGI_APPLICATION = 'legaltech_backend.wsgi.application'
...
# drf-spectacular Settings (OpenAPI Swagger / Redoc)
SPECTACULAR_SETTINGS = {
    'TITLE': 'LegalTech API',
    'DESCRIPTION': 'Enterprise Legal Document Management and Risk Analysis API',
    'VERSION': '1.0.0',
